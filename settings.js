...
module.exports = {
SESSION_ID: process.env.SESSION_ID === undefined ? '𝙰𝚂𝙸𝚃𝙷𝙰-𝙼𝙳=ajo32ZiR#uXkH9-H4A2uqgq9dQprLDa9b9R5p_g6ci-4I6HqQXJI' : process.env.SESSION_ID,
PREFIX: process.env.PREFIX || '.' ,
ALIVE_MSG: process.env.ALIVE_MSG === undefined ? "*Hello , I am alive now!! Deployed by ALPHA TECH  
